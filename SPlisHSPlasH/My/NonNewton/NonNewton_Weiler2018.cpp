#include "NonNewton_Weiler2018.h"
...
int NonNewton_Weiler2018::ITERATIONS = -1;
int NonNewton_Weiler2018::MAX_ITERATIONS = -1;
int NonNewton_Weiler2018::MAX_ERROR = -1;
int NonNewton_Weiler2018::VISCOSITY_COEFFICIENT_BOUNDARY = -1;


#undef USE_AVX

NonNewton_Weiler2018::NonNewton_Weiler2018(FluidModel *model) :
...
void NonNewton_Weiler2018::matrixVecProd(const Real* vec, Real *result, void *userData)
{
	Simulation *sim = Simulation::getCurrent();
	NonNewton_Weiler2018 *visco = (NonNewton_Weiler2018*)userData;
...
void NonNewton_Weiler2018::diagonalMatrixElement(const unsigned int i, Matrix3r &result, void *userData)
{
	// Diagonal element
	Simulation *sim = Simulation::getCurrent();
	NonNewton_Weiler2018 *visco = (NonNewton_Weiler2018*)userData;
...
void NonNewton_Weiler2018::diagonalMatrixElement(const unsigned int i, Vector3r &result, void *userData)
{
	// Diagonal element
	Simulation *sim = Simulation::getCurrent();
	NonNewton_Weiler2018 *visco = (NonNewton_Weiler2018*)userData;
...
void NonNewton_Weiler2018::step()
{
...
void NonNewton_Weiler2018::applyForces(const VectorXr &x) 
{
    const int numParticles = (int) m_model->numActiveParticles();
    Simulation* sim = Simulation::getCurrent();
    const unsigned int nFluids = sim->numberOfFluidModels();
...
void NonNewton_Weiler2018::computeRHS(VectorXr &b, VectorXr &g) 
{
...
void NonNewton_Weiler2018::reset()
{
}

void NonNewton_Weiler2018::performNeighborhoodSearchSort()
{
}
