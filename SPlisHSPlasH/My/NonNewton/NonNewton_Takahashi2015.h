#ifndef __NonNewton_Takahashi2015_h__
#define __NonNewton_Takahashi2015_h__
...
namespace SPH
{
	...
	*/
	class NonNewton_Takahashi2015 : public ViscosityBase
	{
	protected: 
		...
		static void computeViscosityAcceleration(NonNewton_Takahashi2015 *visco, const Real* v);
	...
	public:
		...
		NonNewton_Takahashi2015(FluidModel *model);
		virtual ~NonNewton_Takahashi2015(void);

		static NonPressureForceBase* creator(FluidModel* model) { return new NonNewton_Takahashi2015(model); }
