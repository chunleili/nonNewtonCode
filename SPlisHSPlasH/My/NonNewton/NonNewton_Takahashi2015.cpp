#include "NonNewton_Takahashi2015.h"
...
int NonNewton_Takahashi2015::ITERATIONS = -1;
int NonNewton_Takahashi2015::MAX_ITERATIONS = -1;
int NonNewton_Takahashi2015::MAX_ERROR = -1;

NonNewton_Takahashi2015::NonNewton_Takahashi2015(FluidModel *model) :
	ViscosityBase(model)
{
...
NonNewton_Takahashi2015::~NonNewton_Takahashi2015(void)
{
...
void NonNewton_Takahashi2015::initParameters()
{
...
void NonNewton_Takahashi2015::matrixVecProd(const Real* vec, Real *result, void *userData)
{
	NonNewton_Takahashi2015 *visco = (NonNewton_Takahashi2015*)userData;
...
void NonNewton_Takahashi2015::computeViscosityAcceleration(NonNewton_Takahashi2015 *visco, const Real* v)
{
	...
	#pragma omp parallel default(shared)
	{
		...
		for (int i = 0; i < (int)numParticles; i++)
		{
			...
			visco->getViscousStress(i) = density0 * visco->m_viscosity_nonNewton[i] * (nablaV + nablaV.transpose());
		}
...
void NonNewton_Takahashi2015::step()
{
	Simulation *sim = Simulation::getCurrent();
	...
	// MYADD:
	m_viscosity_nonNewton.resize(numParticles);
...
void NonNewton_Takahashi2015::reset()
{
}

void NonNewton_Takahashi2015::performNeighborhoodSearchSort()
{
}
