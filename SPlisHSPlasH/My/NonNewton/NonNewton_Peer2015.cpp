...
int NonNewton_Peer2015::ITERATIONS = -1;
int NonNewton_Peer2015::MAX_ITERATIONS = -1;
int NonNewton_Peer2015::MAX_ERROR = -1;

NonNewton_Peer2015::NonNewton_Peer2015(FluidModel *model) :
        ViscosityBase(model)
{
...
NonNewton_Peer2015::~NonNewton_Peer2015(void)
{
...
void NonNewton_Peer2015::initParameters()
{
...
void NonNewton_Peer2015::computeDensities()
{
...
void NonNewton_Peer2015::matrixVecProd(const Real* vec, Real *result, void *userData)
{
    Simulation *sim = Simulation::getCurrent();
    NonNewton_Peer2015* visco = (NonNewton_Peer2015*)userData;
...
void NonNewton_Peer2015::diagonalMatrixElement(const unsigned int row, Real &result, void *userData)
{
    // Diagonal element
    NonNewton_Peer2015* visco = (NonNewton_Peer2015*)userData;
    FluidModel* model = visco->getModel();
...
void NonNewton_Peer2015::reset()
{
}

void NonNewton_Peer2015::performNeighborhoodSearchSort()
{
}